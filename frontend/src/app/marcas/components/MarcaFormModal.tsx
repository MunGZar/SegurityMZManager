...
import { marcaSchema, MarcaFormValues } from '../schemas';
...
interface MarcaFormModalProps {
  ...
  onSubmit: (values: MarcaFormValues) => Promise<boolean>;
...
export function MarcaFormModal({
  ...
  const onFormSubmit: SubmitHandler<MarcaFormValues> = async (values) => {
      ...
      <DialogContent className="sm:max-w-[500px] border-zinc-800 bg-zinc-900 text-zinc-100">
        <DialogHeader>
          ...
          <DialogDescription className="text-zinc-400">
            {isEditing
              ...
              : 'Ingresa los datos para registrar una nueva marca de productos.'}
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-4 py-2">
          ...
          <div className="space-y-1.5">
            ...
            <Input
              {...register('nombre')}
              placeholder="Ej. Dahua, Hikvision, Imou"
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              rows={3}
              placeholder="Detalles o especificaciones del fabricante..."
          ...
          <label className="flex items-center justify-between p-3 rounded-lg bg-zinc-950/40 border border-zinc-800/60 cursor-pointer">
            <div>
              <p className="text-sm font-medium text-zinc-200">Marca Activa</p>
              <p className="text-xs text-zinc-500">Determina si la marca está disponible para nuevos productos</p>
            </div>
            <input
              type="checkbox"
              checked={activo}
