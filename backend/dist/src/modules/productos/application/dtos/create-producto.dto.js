...
__decorate([
    (0, swagger_1.ApiProperty)({
        ...
        example: 'Cámara Domo IP 4MP Full Color',
    }),
    (0, class_validator_1.IsString)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        ...
        example: 'Cámara tipo domo metálica para exterior con visión nocturna a color',
    }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        ...
        example: 'https://ejemplo.com/imagenes/camara.jpg',
    }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Precio de compra (Costo)', example: 45.5 }),
...
__decorate([
    (0, swagger_1.ApiProperty)({
        description: 'Porcentaje de margen comercial (%)',
        example: 35,
    }),
    (0, class_transformer_1.Type)(() => Number),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        description: 'Resolución del equipo',
        example: '4MP / 1080p',
    }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        description: 'Tipo o milimetraje de lente',
        example: '2.8mm',
    }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        description: 'Características de audio',
        example: 'Micrófono integrado',
    }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        description: 'Alcance o tecnología de visión nocturna',
        example: 'Smart IR 30m / Full Color',
    }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        description: 'Grado de protección intemperie/golpes',
        example: 'IP67 / IK10',
    }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
