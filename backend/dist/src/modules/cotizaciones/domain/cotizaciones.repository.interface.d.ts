import { Cotizacion, CotizacionDetalle, Cliente, Producto, CotizacionEstado } from '@prisma/client';
...
export declare abstract class ICotizacionesRepository {
    abstract create(data: CreateCotizacionDto & {
        folio: string;
        subtotal: number;
        total: number;
    ...
    abstract update(id: string, data: UpdateCotizacionDto & {
        subtotal?: number;
        total?: number;
    }): Promise<CotizacionConDetalles>;
