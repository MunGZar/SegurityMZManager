import { OrdenTrabajo, OrdenTrabajoEvidencia, Cliente, Cotizacion, CotizacionDetalle, Producto, OrdenTrabajoEstado } from '@prisma/client';
...
export declare abstract class IOrdenesTrabajoRepository {
    abstract create(data: CreateOrdenTrabajoDto & {
        folio: string;
        clienteId: string;
