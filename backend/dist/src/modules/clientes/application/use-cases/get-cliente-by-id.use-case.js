...
exports.GetClienteByIdUseCase = void 0;
const common_1 = require("@nestjs/common");
const clientes_repository_interface_1 = require("../../domain/clientes.repository.interface");
let GetClienteByIdUseCase = class GetClienteByIdUseCase {
    clientesRepository;
...
exports.GetClienteByIdUseCase = GetClienteByIdUseCase;
exports.GetClienteByIdUseCase = GetClienteByIdUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(clientes_repository_interface_1.IClientesRepository)),
    __metadata("design:paramtypes", [Object])
], GetClienteByIdUseCase);
//# sourceMappingURL=get-cliente-by-id.use-case.js.map