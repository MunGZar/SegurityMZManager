...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: 'Inicio de sesión exitoso. Retorna el access token y datos del usuario.',
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        summary: 'Refrescar el access token usando el refresh token almacenado en cookie',
    }),
